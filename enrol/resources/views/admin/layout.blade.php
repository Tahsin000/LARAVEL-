  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{URL::to('/admin_dashboard')}}"> <img src="{{ asset('images/HHJN.svg')}}"  /> </a>
      </div>
    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            <div class="profile">
              <img src="{{ asset('images/Tahsin-Abrar.png') }}" alt="">
            </div>
            <div class="details">
              <p class="user-name">Tahsin Abrar</p>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/cce')}}">CCE</a>
                  </li>
                  <li class="nav-item">
        ...
        <footer class="footer">
          <div class="container-fluid clearfix">
            <span class="float-right">
                <a href="https://github.com/Tahsin000">Tahsin Abrar</a> &copy; 2022
            </span>
          </div>
        </footer>
        <!-- partial -->
